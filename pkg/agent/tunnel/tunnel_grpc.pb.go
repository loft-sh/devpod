...
const (
	...
	Tunnel_GitCloneAndRead_FullMethodName   = "/tunnel.Tunnel/GitCloneAndRead"
	Tunnel_ReadWorkspace_FullMethodName     = "/tunnel.Tunnel/ReadWorkspace"
...
type TunnelClient interface {
	...
	GitCloneAndRead(ctx context.Context, in *Empty, opts ...grpc.CallOption) (Tunnel_GitCloneAndReadClient, error)
...
func (c *tunnelClient) Ping(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
	err := c.cc.Invoke(ctx, Tunnel_Ping_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *tunnelClient) Log(ctx context.Context, in *LogMessage, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
	err := c.cc.Invoke(ctx, Tunnel_Log_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *tunnelClient) GitCloneAndRead(ctx context.Context, in *Empty, opts ...grpc.CallOption) (Tunnel_GitCloneAndReadClient, error) {
	stream, err := c.cc.NewStream(ctx, &Tunnel_ServiceDesc.Streams[0], Tunnel_GitCloneAndRead_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
	x := &tunnelGitCloneAndReadClient{stream}
...
type Tunnel_GitCloneAndReadClient interface {
	Recv() (*Chunk, error)
	grpc.ClientStream
}

type tunnelGitCloneAndReadClient struct {
	grpc.ClientStream
}

func (x *tunnelGitCloneAndReadClient) Recv() (*Chunk, error) {
	m := new(Chunk)
...
func (c *tunnelClient) ReadWorkspace(ctx context.Context, in *Empty, opts ...grpc.CallOption) (Tunnel_ReadWorkspaceClient, error) {
	stream, err := c.cc.NewStream(ctx, &Tunnel_ServiceDesc.Streams[1], Tunnel_ReadWorkspace_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *tunnelClient) SendResult(ctx context.Context, in *Message, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
	err := c.cc.Invoke(ctx, Tunnel_SendResult_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *tunnelClient) DockerCredentials(ctx context.Context, in *Message, opts ...grpc.CallOption) (*Message, error) {
	out := new(Message)
	err := c.cc.Invoke(ctx, Tunnel_DockerCredentials_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *tunnelClient) GitCredentials(ctx context.Context, in *Message, opts ...grpc.CallOption) (*Message, error) {
	out := new(Message)
	err := c.cc.Invoke(ctx, Tunnel_GitCredentials_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *tunnelClient) GitUser(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*Message, error) {
	out := new(Message)
	err := c.cc.Invoke(ctx, Tunnel_GitUser_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *tunnelClient) ForwardPort(ctx context.Context, in *ForwardPortRequest, opts ...grpc.CallOption) (*ForwardPortResponse, error) {
	...
	err := c.cc.Invoke(ctx, Tunnel_ForwardPort_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *tunnelClient) StopForwardPort(ctx context.Context, in *StopForwardPortRequest, opts ...grpc.CallOption) (*StopForwardPortResponse, error) {
	...
	err := c.cc.Invoke(ctx, Tunnel_StopForwardPort_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TunnelServer interface {
	...
	GitCloneAndRead(*Empty, Tunnel_GitCloneAndReadServer) error
...
func (UnimplementedTunnelServer) GitCloneAndRead(*Empty, Tunnel_GitCloneAndReadServer) error {
	return status.Errorf(codes.Unimplemented, "method GitCloneAndRead not implemented")
}
...
func _Tunnel_GitCloneAndRead_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(Empty)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(TunnelServer).GitCloneAndRead(m, &tunnelGitCloneAndReadServer{stream})
}

type Tunnel_GitCloneAndReadServer interface {
	Send(*Chunk) error
	grpc.ServerStream
}

type tunnelGitCloneAndReadServer struct {
	grpc.ServerStream
}

func (x *tunnelGitCloneAndReadServer) Send(m *Chunk) error {
...
var Tunnel_ServiceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		{
			StreamName:    "GitCloneAndRead",
			Handler:       _Tunnel_GitCloneAndRead_Handler,
			ServerStreams: true,
		},
		{
