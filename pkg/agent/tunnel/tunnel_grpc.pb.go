...
type TunnelClient interface {
	...
	DockerBuildxCredentials(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*Message, error)
...
func (c *tunnelClient) DockerBuildxCredentials(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*Message, error) {
	out := new(Message)
	err := c.cc.Invoke(ctx, "/tunnel.Tunnel/DockerBuildxCredentials", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *tunnelClient) StreamGitClone(ctx context.Context, in *Empty, opts ...grpc.CallOption) (Tunnel_StreamGitCloneClient, error) {
	stream, err := c.cc.NewStream(ctx, &Tunnel_ServiceDesc.Streams[0], "/tunnel.Tunnel/StreamGitClone", opts...)
	if err != nil {
		return nil, err
	}
	x := &tunnelStreamGitCloneClient{stream}
...
func (c *tunnelClient) StreamWorkspace(ctx context.Context, in *Empty, opts ...grpc.CallOption) (Tunnel_StreamWorkspaceClient, error) {
	stream, err := c.cc.NewStream(ctx, &Tunnel_ServiceDesc.Streams[1], "/tunnel.Tunnel/StreamWorkspace", opts...)
	if err != nil {
		return nil, err
	}
	x := &tunnelStreamWorkspaceClient{stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
func (c *tunnelClient) StreamMount(ctx context.Context, in *StreamMountRequest, opts ...grpc.CallOption) (Tunnel_StreamMountClient, error) {
	stream, err := c.cc.NewStream(ctx, &Tunnel_ServiceDesc.Streams[2], "/tunnel.Tunnel/StreamMount", opts...)
	if err != nil {
		return nil, err
	}
	x := &tunnelStreamMountClient{stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
type TunnelServer interface {
	...
	DockerBuildxCredentials(context.Context, *Empty) (*Message, error)
...
func (UnimplementedTunnelServer) DockerBuildxCredentials(context.Context, *Empty) (*Message, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DockerBuildxCredentials not implemented")
}
...
func _Tunnel_DockerBuildxCredentials_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TunnelServer).DockerBuildxCredentials(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tunnel.Tunnel/DockerBuildxCredentials",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TunnelServer).DockerBuildxCredentials(ctx, req.(*Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Tunnel_StreamGitClone_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(TunnelServer).StreamGitClone(m, &tunnelStreamGitCloneServer{stream})
}
...
func _Tunnel_StreamWorkspace_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(TunnelServer).StreamWorkspace(m, &tunnelStreamWorkspaceServer{stream})
}
...
func _Tunnel_StreamMount_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(TunnelServer).StreamMount(m, &tunnelStreamMountServer{stream})
}
...
var Tunnel_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "DockerBuildxCredentials",
			Handler:    _Tunnel_DockerBuildxCredentials_Handler,
		},
		{
