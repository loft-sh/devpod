...
var file_tunnel_proto_rawDesc = []byte{
	...
	0x52, 0x52, 0x4f, 0x52, 0x10, 0x04, 0x32, 0xd6, 0x05, 0x0a, 0x06, 0x54, 0x75, 0x6e, 0x6e, 0x65,
	...
	0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x22, 0x00, 0x12, 0x2e, 0x0a, 0x0a, 0x4c, 0x6f, 0x66, 0x74,
	0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12, 0x0d, 0x2e, 0x74, 0x75, 0x6e, 0x6e, 0x65, 0x6c, 0x2e,
	0x45, 0x6d, 0x70, 0x74, 0x79, 0x1a, 0x0f, 0x2e, 0x74, 0x75, 0x6e, 0x6e, 0x65, 0x6c, 0x2e, 0x4d,
	...
	0x74, 0x6f, 0x70, 0x46, 0x6f, 0x72, 0x77, 0x61, 0x72, 0x64, 0x50, 0x6f, 0x72, 0x74, 0x52, 0x65,
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x32, 0x0a, 0x0e, 0x53, 0x74, 0x72, 0x65,
	0x61, 0x6d, 0x47, 0x69, 0x74, 0x43, 0x6c, 0x6f, 0x6e, 0x65, 0x12, 0x0d, 0x2e, 0x74, 0x75, 0x6e,
	0x6e, 0x65, 0x6c, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x1a, 0x0d, 0x2e, 0x74, 0x75, 0x6e, 0x6e,
	0x65, 0x6c, 0x2e, 0x43, 0x68, 0x75, 0x6e, 0x6b, 0x22, 0x00, 0x30, 0x01, 0x12, 0x33, 0x0a, 0x0f,
	...
	0x01, 0x12, 0x3c, 0x0a, 0x0b, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x4d, 0x6f, 0x75, 0x6e, 0x74,
	0x12, 0x1a, 0x2e, 0x74, 0x75, 0x6e, 0x6e, 0x65, 0x6c, 0x2e, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d,
	0x4d, 0x6f, 0x75, 0x6e, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x0d, 0x2e, 0x74,
	0x75, 0x6e, 0x6e, 0x65, 0x6c, 0x2e, 0x43, 0x68, 0x75, 0x6e, 0x6b, 0x22, 0x00, 0x30, 0x01, 0x42,
	0x2c, 0x5a, 0x2a, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x6c, 0x6f,
	0x66, 0x74, 0x2d, 0x73, 0x68, 0x2f, 0x64, 0x65, 0x76, 0x70, 0x6f, 0x64, 0x2f, 0x70, 0x6b, 0x67,
	0x2f, 0x61, 0x67, 0x65, 0x6e, 0x74, 0x2f, 0x74, 0x75, 0x6e, 0x6e, 0x65, 0x6c, 0x62, 0x06, 0x70,
...
var file_tunnel_proto_depIdxs = []int32{
	...
	9,  // 8: tunnel.Tunnel.LoftConfig:input_type -> tunnel.Empty
	4,  // 9: tunnel.Tunnel.ForwardPort:input_type -> tunnel.ForwardPortRequest
	2,  // 10: tunnel.Tunnel.StopForwardPort:input_type -> tunnel.StopForwardPortRequest
	9,  // 11: tunnel.Tunnel.StreamGitClone:input_type -> tunnel.Empty
	9,  // 12: tunnel.Tunnel.StreamWorkspace:input_type -> tunnel.Empty
	1,  // 13: tunnel.Tunnel.StreamMount:input_type -> tunnel.StreamMountRequest
	9,  // 14: tunnel.Tunnel.Ping:output_type -> tunnel.Empty
	9,  // 15: tunnel.Tunnel.Log:output_type -> tunnel.Empty
	9,  // 16: tunnel.Tunnel.SendResult:output_type -> tunnel.Empty
	6,  // 17: tunnel.Tunnel.DockerCredentials:output_type -> tunnel.Message
	6,  // 18: tunnel.Tunnel.GitCredentials:output_type -> tunnel.Message
	6,  // 19: tunnel.Tunnel.GitSSHSignature:output_type -> tunnel.Message
	6,  // 20: tunnel.Tunnel.GitUser:output_type -> tunnel.Message
	6,  // 21: tunnel.Tunnel.LoftConfig:output_type -> tunnel.Message
	5,  // 22: tunnel.Tunnel.ForwardPort:output_type -> tunnel.ForwardPortResponse
	3,  // 23: tunnel.Tunnel.StopForwardPort:output_type -> tunnel.StopForwardPortResponse
	7,  // 24: tunnel.Tunnel.StreamGitClone:output_type -> tunnel.Chunk
	7,  // 25: tunnel.Tunnel.StreamWorkspace:output_type -> tunnel.Chunk
	7,  // 26: tunnel.Tunnel.StreamMount:output_type -> tunnel.Chunk
...
func file_tunnel_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_tunnel_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*StreamMountRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
