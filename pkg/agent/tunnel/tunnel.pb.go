...
var file_tunnel_proto_rawDesc = []byte{
	...
	0x32, 0xf5, 0x01, 0x0a, 0x06, 0x54, 0x75, 0x6e, 0x6e, 0x65, 0x6c, 0x12, 0x26, 0x0a, 0x04, 0x50,
	...
	0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x22, 0x00, 0x42, 0x2c, 0x5a, 0x2a, 0x67, 0x69, 0x74, 0x68,
...
var file_tunnel_proto_depIdxs = []int32{
	...
	4, // 6: tunnel.Tunnel.Ping:output_type -> tunnel.Empty
	4, // 7: tunnel.Tunnel.Log:output_type -> tunnel.Empty
	2, // 8: tunnel.Tunnel.ReadWorkspace:output_type -> tunnel.Chunk
	4, // 9: tunnel.Tunnel.SendResult:output_type -> tunnel.Empty
	1, // 10: tunnel.Tunnel.GitCredentials:output_type -> tunnel.Message
