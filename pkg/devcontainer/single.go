...
func GetStartScript(mergedConfig *config.MergedDevContainer) string {
...
func GetContainerEntrypointAndArgs(mergedConfig *config.MergedDevContainer, imageDetails *config.ImageDetails) (string, []string) {
