...
When DevPod starts a workspace, such as `devpod up`, devpod selects a provider based on your context and starts your devcontainer. If using a machine provider, devpod will check if it should create a VM first.
