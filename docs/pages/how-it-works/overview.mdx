...
functions such as port forwarding, log streaming and more. Doing so it provides a control plane across your development environment. DevPod can be thought of as a minimal service mesh, specifically
