...
Providers in DevPod are defined through a `provider.yaml` that define the necessary options, configuration, binaries and commands needed to handle workspace creation.
