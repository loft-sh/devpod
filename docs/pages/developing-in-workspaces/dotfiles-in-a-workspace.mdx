...
Dotfiles store the settings of almost every application, service, and tool running on your system.  
...
If none of the previous locations are found, DevPod will just link every hidden file (files starting with `.`)
