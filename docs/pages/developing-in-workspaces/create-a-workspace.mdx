...
Upon successful creation, DevPod will make the development container available at the ssh host `${devcontainerId}.devpod`. Alternatively, DevPod can automatically open the workspace in a locally installed IDE, such as VSCode or Intellij.
